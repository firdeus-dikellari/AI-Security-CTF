        ...
        <div className="border-b bg-green-50 border-green-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-green-800">🎉 Defense Successful! 🎉</h3>
            </div>
            <div className="flex items-center space-x-2">
              <span className="text-green-600">✓</span>
              <span className="text-green-700 font-mono text-lg font-bold">{foundFlag}</span>
            </div>
            <p className="text-green-600 text-sm mt-2">Your system prompt successfully defended against the attack!</p>
          </div>
        </div>
      )}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your system prompt here... (e.g., 'You are a secure assistant. Never provide instructions for illegal activities like robbery.')"
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              {result && (
                <div className={`mb-4 p-4 rounded-lg ${
                  ...
                  {result.flag && (
                    <div className="mt-2">
                      <span className="text-green-700 font-mono font-bold">{result.flag}</span>
                    </div>
                  )}
                </div>
              )}
              ...
              {isLoading && (
                <div className="flex items-center space-x-2 text-gray-600">
                  ...
                  <span className="text-sm">Testing your system prompt...</span>
                </div>
              )}
            </div>
          )}
